...
<body>
	...
	<section id="about" class="py-5">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container-fluid"> <a class="navbar-brand" href="#">KINO MIR</a> <button class="navbar-toggler" style="background-color: rgb(244, 38, 169);" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
		...
		<div class="container">
			...
			<div class="advantages">
				<div class="container">
					<div class="name"> С нами <span>вы не соскучитесь</span> </div>
					<div class="row flex">
						<div class="col-lg-3 col-md-6 col-sm-6 item"> <span>Залы с кинотеатрами</span> (2-30 человек) </div>
						<div class="col-lg-3 col-md-6 col-sm-6 item"> <span>Залы с караоке</span> (шумоизоляция) </div>
						<div class="col-lg-3 col-md-6 col-sm-6 item"> <span>Залы с PS5, XBOX X</span> (4 джойстика, 40+ игр) </div>
						<div class="col-lg-3 col-md-6 col-sm-6 item last"> <span>Возможность</span> приносить свою еду </div>
					</div>
				</div>
			</div>
			<!-- Блок 4 -->
	...
	<section id="forTwo" class="py-5">
		<div class="container">
			...
			<!-- Тариф "Возлюбленные" -->
			<div class="mb-4">
				<div id="sliderLovers" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
					...
					<div class="carousel-inner">
						<div class="carousel-item active"> <img src="/images/IMG_1290.JPG" class="d-block w-100" alt="Image description 1"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1291.JPG" class="d-block w-100" alt="Image description 2"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1292.JPG" class="d-block w-100" alt="Image description 3"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1293.jpg" class="d-block w-100" alt="Image description 4"> </div>
					</div>
				</div>
				<h4>"Возлюбленные"</h4>
    ...
    Забронировать
			...
			<!-- Тариф "Сладкоежки" -->
			<div class="mb-4">
				<div id="sliderSweet" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
					<!-- Индикаторы для слайдера -->
					<ol class="carousel-indicators">
					...
					<!-- Сами изображения для слайдера -->
					<div class="carousel-inner">
						<div class="carousel-item active"> <img src="/images/IMG_1258.JPG" class="d-block w-100" alt="Image description 1"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1259.JPG" class="d-block w-100" alt="Image description 2"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1260.JPG" class="d-block w-100" alt="Image description 3"> </div>
					</div>
				</div>
				<h4>"Сладкоежки"</h4>
    ...
    Забронировать
			...
			<div class="mb-4">
				<div id="sliderEnjoyment" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
					<!-- Индикаторы для слайдера -->
					<ol class="carousel-indicators">
					...
					<!-- Сами изображения для слайдера -->
					<div class="carousel-inner">
						<div class="carousel-item active"> <img src="/images/IMG_1282.JPG" class="d-block w-100" alt="Image description 1"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1283.JPG" class="d-block w-100" alt="Image description 2"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1284.JPG" class="d-block w-100" alt="Image description 3"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1286.JPG" class="d-block w-100" alt="Image description 4"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1287.JPG" class="d-block w-100" alt="Image description 5"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1285.JPG" class="d-block w-100" alt="Image description 6"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1288.JPG" class="d-block w-100" alt="Image description 7"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1289.JPG" class="d-block w-100" alt="Image description 8"> </div>
					</div>
				</div>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="bookingModalLabel">Бронирование кинозала <span id="tariffName"></span></h5> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> </div>
				<div class="modal-body">
					<form id="bookingForm">
						...
						<div class="mb-3 form-check"> <input type="checkbox" class="form-check-input" id="pizza" data-price="4300₸"> <label class="form-check-label" for="pizza">Пицца (4300₸)</label> </div>
						<div class="mb-3 form-check"> <input type="checkbox" class="form-check-input" id="sandwich" data-price="3500₸"> <label class="form-check-label" for="sandwich">Клаб сэндвичи (3500₸)</label> </div>
						<div class="mb-3 form-check"> <input type="checkbox" class="form-check-input" id="rug" data-price="Бесплатно"> <label class="form-check-label" for="rug">Плед (Бесплатно)</label> </div>
						<!-- Аналогично добавьте другие дополнительные услуги -->
						<p>Примечание: "В случае выбора доп. услуг, менеджер свяжется для уточнения".</p>
						<div class="mb-3"> <label for="totalPrice" class="form-label">Итоговая сумма:</label> <input type="text" class="form-control" id="totalPrice" readonly> </div>
					</form>
				</div>
				<div class="modal-footer"> <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Закрыть</button> <button type="button" class="btn btn-primary">Подтвердить</button> </div>
			</div>
		</div>
	</div>
	<!-- Секция "Для компаний" -->
	<section id="forCompanies" class="py-5">
		<div class="container">
			...
			<!-- Тариф "Семейный" -->
			<div class="mb-4">
				<div id="sliderFamily" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
					<!-- Индикаторы для слайдера -->
					<ol class="carousel-indicators">
					...
					<!-- Сами изображения для слайдера -->
					<div class="carousel-inner">
						<div class="carousel-item active"> <img src="/images/IMG_1275.JPG" class="d-block w-100" alt="Image description 1"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1273.JPG" class="d-block w-100" alt="Image description 2"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1274.JPG" class="d-block w-100" alt="Image description 3"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1277.JPG" class="d-block w-100" alt="Image description 4"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1278.JPG" class="d-block w-100" alt="Image description 5"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1276.JPG" class="d-block w-100" alt="Image description 6"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1279.JPG" class="d-block w-100" alt="Image description 7"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1280.JPG" class="d-block w-100" alt="Image description 8"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1281.JPG" class="d-block w-100" alt="Image description 9"> </div>
					</div>
				</div>
				<h4>"Семейный"</h4>
    ...
    Забронировать
			...
			<!-- Дневной -->
			<div class="mb-4">
				<div id="sliderDaytime" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
					<!-- Индикаторы для слайдера -->
					<ol class="carousel-indicators">
					...
					<!-- Сами изображения для слайдера -->
					<div class="carousel-inner">
						<div class="carousel-item active"> <img src="/images/IMG_1267.JPG" class="d-block w-100" alt="Image description 1"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1268.JPG" class="d-block w-100" alt="Image description 2"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1269.JPG" class="d-block w-100" alt="Image description 3"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1270.JPG" class="d-block w-100" alt="Image description 4"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1272.JPG" class="d-block w-100" alt="Image description 5"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1271.JPG" class="d-block w-100" alt="Image description 6"> </div>
					</div>
				</div>
				<h4>"Дневной"</h4>
				<p>Описание тарифа: Караоке, предварительно подготовленный фильм на выбор, коллекция настольных игр, XBOX/PS5, безлимитные печеньки и горячие напитки в главном зале, пицца 40 см.</p>
    ...
    Забронировать
			...
			<!-- Большой праздник -->
			<div class="mb-4">
				<div id="sliderHoliday" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
					<!-- Индикаторы для слайдера -->
					<ol class="carousel-indicators">
					...
					<!-- Сами изображения для слайдера -->
					<div class="carousel-inner">
						<div class="carousel-item active"> <img src="/images/IMG_1262.JPG" class="d-block w-100" alt="Image description 1"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1263.JPG" class="d-block w-100" alt="Image description 2"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1261.JPG" class="d-block w-100" alt="Image description 3"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1264.JPG" class="d-block w-100" alt="Image description 4"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1265.JPG" class="d-block w-100" alt="Image description 5"> </div>
						<div class="carousel-item"> <img src="/images/IMG_1266.JPG" class="d-block w-100" alt="Image description 6"> </div>
					</div>
				</div>
			...
			<div class="accordion" id="faqAccordion">
				...
				<div class="accordion-item">
					...
					<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
						<div class="accordion-body"> Нет. Ни один из наших залов не оснащен прослушкой или же скрытыми камерами. Двери в залы закрываются изнутри, а если вам понадобится кто-то из персонала, то в каждом зале есть кнопка вызова. </div>
					</div>
				</div>
				<!-- Вопрос 2 -->
				<div class="accordion-item">
					...
					<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion">
						<div class="accordion-body"> Конечно! Мы будем только рады, если вы уйдёте от нас сытыми и довольными. Мы можем предложить вам безлимитный запас горячих напитков и сладостей, также у нас есть своя кухня. </div>
					</div>
				</div>
				<!-- Вопрос 3 -->
				<div class="accordion-item">
					...
					<div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
						<div class="accordion-body"> Внутри нашего кинотеатра по соображениям безопасности и комфорта других посетителей курить традиционные сигареты запрещается. Однако употребление одноразовых электронных сигарет и кальяна разрешено. </div>
					</div>
				</div>
				<!-- Вопрос 4 -->
				<div class="accordion-item">
					...
					<div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#faqAccordion">
						<div class="accordion-body"> Несовершеннолетнему находиться внутри нашего зала можно до 22:00. После лишь при сопровождении родителей. </div>
					</div>
				</div>
